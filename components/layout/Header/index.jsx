...
import JaLogo from '@/components/ui/JaLogo';
    ...
    >
        ...
        >
            <motion.div
                ...
                whileTap={{ scale: 0.95 }}
            >
                <JaLogo className={`${isMobile ? 'w-10 h-10' : 'w-12 h-12 sm:w-14 sm:h-14'}`} />
            </motion.div>
            <motion.span
...
const ContactButton = ({ isMobile = false, onLinkClick }) => (
    <motion.div
        ...
        onClick={onLinkClick}
    >
        <Link href={"https://drive.google.com/file/d/1gOExSh4BYd55AUJCGi7TcalOtCY42mZT/view?usp=drive_link"} target='_blank' className={isMobile ? 'w-full' : ''}>
